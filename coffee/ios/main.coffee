class Icon
    constructor: (@id, @title) ->
        @markup = """<div class="icon" 
            style="background-image:url(assets/img/icons/#{@id}.png" 
            title="#{@title}"></div>"""
